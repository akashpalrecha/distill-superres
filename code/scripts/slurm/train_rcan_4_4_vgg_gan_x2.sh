...
echo "---- BEGIN TRAINING ----"
echo ""
python train.py --ckp_dir overall_distillation/rcan/vgg_4_4_x2/ --scale 2 --teacher [RCAN] --model RCAN --n_resblocks 4 --n_resgroups 4 --alpha 0.5 --feature_loss_used 0 --wgan --epochs 100 --patch_size 96 --chop --d_lr 0.000005 --no_critic_clip --d_loss_weight 10.0
echo ""
