...
parser.add_argument('--use_last_feature', action='store_true', help='model additionally returns last feature map before upsampling')
parser.add_argument('--use_teacher_weights', action='store_true', help='load matchine keys into student from teacher')
parser.add_argument('--freeze_upsampler', action='store_true', help='freeze upsampling `tail` module in student')
...
# WGAN Training params
parser.add_argument('--wgan', action='store_true', help='use wgan training')
parser.add_argument('--d_lr', type=float, default=0.00005)
parser.add_argument('--d_optimizer', default= 'RMSprop', type=str, help='Optimizer used for discriminator')
